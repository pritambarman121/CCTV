...
label_title = Label(mainFrame,text = "CCTV CAMERA",font=('Helvitica',40,'bold'))
...
label_icon_1.grid(row=0,pady=(5,10),column=0)   #title icon
...
btn=Button(mainFrame,font=('Helvitica',20,'bold'),height=90,width=170,image=btn_image,compound='left',command=record)
...
btn=Button(mainFrame,font=('Helvitica',20,'bold'),height=90,width=170,image=btn_image1,compound='left')
btn.grid(row=3,pady=(10,10),column=1)
...
btn=Button(mainFrame,font=('Helvitica',20,'bold'),height=90,width=170,image=btn_image2,compound='left',command=window.quit)
btn.grid(row=4,pady=(10,10),column=1)
